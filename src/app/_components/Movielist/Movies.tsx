...
const Movies = ({ img, rate, title }: MovieList) => {
  return (
    <div className="bg-[#F4F4F5] dark:bg-[#27272A] rounded-lg min-w-[157.5px] min-h-[309.0999755859375px] w-full h-full xl:w-[218.24324951171875px] xl:h-[417.05px] cursor-pointer">
      <img
